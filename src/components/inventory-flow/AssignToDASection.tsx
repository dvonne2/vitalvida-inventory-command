...
import { Users, Loader2, Package } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${quantityToAssign} units of ${selectedProduct?.name} assigned to ${selectedDA?.name}`,
        variant: "default"
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Enter any assignment remarks or notes"
              className="bg-slate-700 border-slate-600 text-white"
              rows={3}
            />
          </div>
          ...
          <Button
            type="submit"
            disabled={isSubmitting || !formData.product_id || !formData.delivery_agent_id || !formData.quantity_to_assign}
